...
public class FlowerRainbowWriteTimer implements BackgroundTimer.TimeExpireListener {
    ...
    private final FlowerRainbowStateHandler flowerStateHandler;


    public FlowerRainbowWriteTimer(FlowerRainbowStateHandler flowerStateHandler) {
