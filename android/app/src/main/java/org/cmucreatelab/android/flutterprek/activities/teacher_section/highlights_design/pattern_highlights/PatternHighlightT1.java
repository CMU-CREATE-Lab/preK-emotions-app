...
public class PatternHighlightT1 extends PatternHighlightQuery {


    public PatternHighlightT1(AbstractActivity activity, List<String> studentUuids) {
    ...
    public String generateTitle() {
        ...
        return context.getString(R.string.pattern_highlights_t1_title);
    }
    ...
    public String generateCollapsibleDescription() {
        Context context = MindfulnestApplication.getInstanceOfApplicationContext();
        return context.getString(R.string.pattern_highlights_t1_description);
    }
