package org.cmucreatelab.android.flutterprek.activities.teacher_section.highlights_design.settings;
...
import org.cmucreatelab.android.flutterprek.activities.teacher_section.highlights_design.settings.troubleshoot_device.SettingsTroubleshootDeviceIndex;
import org.cmucreatelab.android.flutterprek.activities.teacher_section.highlights_design.views.HighlightsViewDrawer;

public class HighlightsDesignAppSettingsMainActivity extends HighlightsDesignActivityWithHeaderAndDrawer {
    ...
    private void startSettingsBleActivity(HighlightsDesignAppSettingsBleActivity.DeviceType deviceType) {
        Intent settingsBleActivity = new Intent(getApplicationContext(), HighlightsDesignAppSettingsBleActivity.class);
        settingsBleActivity.putExtra(HighlightsDesignAppSettingsBleActivity.EXTRA_DEVICE, new HighlightsDesignAppSettingsBleActivity.Device(deviceType));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO set navigation back to... something? (gonna need passed intent AT LEAST for a string name, but I can call finish() to just pop back)
        ...
        flowerBleSettings.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startSettingsBleActivity(HighlightsDesignAppSettingsBleActivity.DeviceType.FLOWER);
            }
        });
        squeezeBleSettings.button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startSettingsBleActivity(HighlightsDesignAppSettingsBleActivity.DeviceType.SQUEEZE);
            }
        });
        wandBleSettings.button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startSettingsBleActivity(HighlightsDesignAppSettingsBleActivity.DeviceType.WAND);
            }
        });
        ...
        findViewById(R.id.textButtonTroubleshootDevices).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // TODO Highlights Design for Troubleshoot Devices
...
//    }
    ...
    public int getResourceIdForActivityLayout() {
        return R.layout._highlights_design__activity_app_settings_main;
    }
