...
public class StudentWithCustomizationsIndexAdapter extends AbstractListAdapter<StudentWithCustomizations> {
    ...
    public StudentWithCustomizationsIndexAdapter(AppCompatActivity activity, List<StudentWithCustomizations> students) {
        this(activity, students, null);
    }


    public StudentWithCustomizationsIndexAdapter(AppCompatActivity activity, List<StudentWithCustomizations> students, ClickListener clickListener) {
