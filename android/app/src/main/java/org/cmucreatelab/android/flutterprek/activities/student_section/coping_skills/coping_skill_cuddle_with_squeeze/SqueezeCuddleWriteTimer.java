...
public class SqueezeCuddleWriteTimer implements BackgroundTimer.TimeExpireListener {
    ...
    private final SqueezeCuddleStateHandler squeezeStateHandler;


    public SqueezeCuddleWriteTimer(SqueezeCuddleStateHandler squeezeStateHandler) {
