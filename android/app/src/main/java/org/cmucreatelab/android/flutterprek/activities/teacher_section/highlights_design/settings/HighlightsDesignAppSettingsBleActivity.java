...
public class HighlightsDesignAppSettingsBleActivity extends HighlightsDesignActivityWithHeaderAndDrawer implements ScanViewAdapter.OnListInteractionListener {
...
//        });
        textViewButtonEnterDeviceName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(HighlightsDesignAppSettingsBleActivity.this);
...
//    }
    ...
    public int getResourceIdForActivityLayout() {
        return R.layout._highlights_design__activity_settings_ble_device_with_drawer;
    }
