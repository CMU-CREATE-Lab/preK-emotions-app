...
public class RecordFragment extends TalkAboutItFragment {
    ...
    public int getInflatedLayoutResource() {
        return R.layout._student_section__fragment_choose_emotion_talk_about_it;
    }
    ...
    public void displayFragment(FragmentState fragmentStateToDisplay, ActivityCallback activity) {
        ...
        boolean display = fragmentStateToDisplay == FragmentState.RECORD;
    ...
    public void stopRecordingAndMoveOn() {
        ...
        stopRecording();
        getActivityCallback().setFragment(FragmentState.EMOTION_OR_PLAYBACK);
    }
